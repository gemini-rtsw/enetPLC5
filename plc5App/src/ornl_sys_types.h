...
/*#include "unix.msh" */
#define UNIX_ERROR 0x30001002
#define UNIX_ERROR_IDX 82
#define UNIX_SUCCESS 0x10001001
#define UNIX_SUCCESS_IDX 83

/*#include "sys.msh"*/
#define SYS_FAIL 0x30008002
#define SYS_FAIL_IDX 71
#define SYS_ONEENTQUE 0x10008001
#define SYS_ONEENTQUE_IDX 72
#define SYS_QUEWASEMP 0x30008004
#define SYS_QUEWASEMP_IDX 73
...
typedef struct sys_time_tag {
  ...
  time_t cal_time;
  struct tm tm_time;
} SYS_TIME_TYPE, *SYS_TIME_PTR;

typedef struct sys_proc_id_tag {
  pid_t id;
} SYS_PROC_ID_TYPE, *SYS_PROC_ID_PTR;
